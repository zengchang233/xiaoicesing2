...
if __name__ == "__main__":
    import sys
    sys.path.insert(0, '/home/zengchang/code/acoustic_v2/modules_v2/transformer')
    fft_block = FFTBlock(512, 8, 64, 64, 2048, [3,3])
    x = torch.randn(2, 100, 512)
    mask = torch.ones(2, 100).bool()
    slf_attn_mask = torch.ones(2, 100, 100).bool()
    y, attn = fft_block(x, mask, slf_attn_mask)
    print(y.shape)
    print(attn.shape)